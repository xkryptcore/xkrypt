...
{
	resize(1250, 520);
	setWindowTitle(tr("XKY") + " - " + tr("Wallet"));
	qApp->setStyleSheet("QMainWindow { background-image:url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; }"
		"QPushButton    { color:#ecf0f1; border-radius:5px; border:solid 1px #E5D738; background:#b4b4b4;  padding:3px 30px; -webkit-transition: all 0.1s; -moz-transition: all 0.1s; transition: all 0.1s; -webkit-box-shadow: 0px 6px 0px #d35400; -moz-box-shadow: 0px 6px 0px #d35400; box-shadow: 0px 6px 0px #E5D738;}"
...
#endif
	setObjectName("XKY");
	setStyleSheet("#XKY { background-color: white }");
	// Accept D&D of URIs
	setAcceptDrops(true);
	...
	frameBlocks->setStyleSheet("QWidget { background: white; margin-bottom: 5px; }");
	...
	if (!fUseBlackTheme)
	{
		...
		{
			progressBar->setStyleSheet("QProgressBar { color: #ffffff;background-color: #e8e8e8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: white); border-radius: 7px; margin: 0px; }");
		}
	}
	...
	statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: white}");
...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setToolTip(tr("Send coins to a XKY address"));
	...
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About XKY"), this);
	aboutAction->setToolTip(tr("Show information about XKY"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setToolTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setToolTip(tr("Modify configuration options for XKY"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #000000; font-size: 13px; font-weight: 400; padding:5px; font-family: 'Verdana'; border: none; }"
		"QToolButton:hover { background-color: #ffffff; color: #000000; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #ffffff; color: #000000; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { background-color: #ffffff; color: #000000; border: none; padding-top: 5px; padding-bottom: 5px; }"
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	if (clientModel)
	{
		...
		if (clientModel->isTestNet())
		{
			...
			if (trayIcon)
			{
				trayIcon->setToolTip(tr("XKY client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
	...
	trayIcon->setToolTip(tr("XKY client"));
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XKY network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
	if (event->mimeData()->hasUrls())
	{
		...
		if (nValidUrisFound)
			...
			notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid XKY address or malformed URI parameters."));
	}
