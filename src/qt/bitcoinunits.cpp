...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XKY");
    case mBTC: return QString("mXKY");
    case uBTC: return QString::fromUtf8("μXKY");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XKYs");
    case mBTC: return QString("Milli-XKYs (1 / 1,000)");
    case uBTC: return QString("Micro-XKYs (1 / 1,000,000)");
    default: return QString("???");
    }
}
