...
private slots:
    ...
    QString BuyXKY(QString OrderType, double Quantity, double Rate);
    QString SellXKY(QString OrderType, double Quantity, double Rate);
