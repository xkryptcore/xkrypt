...
const string strMessageMagic = "XKY Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1){
      ...
      nSubsidy = 50000 * COIN;
    } else if (nHeight > 5 && nHeight <= 1000){
      nSubsidy = 5 * COIN;
      ...
      nSubsidy = 60 * COIN;
    } else if(nHeight > 175000 && nHeight <= 250000){
      nSubsidy = 40 * COIN;
    } else if(nHeight > 250000 && nHeight <= 375000){
      nSubsidy = 20 * COIN;
    } else if(nHeight > 375000 && nHeight <= 500000){
      nSubsidy = 10 * COIN;
    } else {
      nSubsidy = 5 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 100000 && nBestHeight <= 175000){
      nSubsidy = 60 * COIN;
    } else if(nBestHeight >= 175000 && nBestHeight < 250000){
      nSubsidy = 40 * COIN;
    } else if(nBestHeight >= 250000 && nBestHeight < 375000){
      nSubsidy = 20 * COIN;
    } else if(nBestHeight >= 375000 && nBestHeight < 500000){
      nSubsidy = 10 * COIN;
    } else{
      nSubsidy = 5 * COIN;
    }
