...
#define START_MASTERNODE_PAYMENTS_TESTNET 1520179200
#define START_MASTERNODE_PAYMENTS 1520179200

static const int64_t DARKSEND_COLLATERAL = (1000*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 1000 * COIN; //Constant reward of 10 XKY per COIN i.e. 8%
